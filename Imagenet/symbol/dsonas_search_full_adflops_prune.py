...
lambda_list = [0]
for i in range(1, num_operation):
...
def dsonas_adflops_prune(units, num_stages, filter_list, num_classes, image_shape, num_layers=2, bn_mom=0.9,
                         workspace=256,
...
def get_symbol_dsonas_search_full_adflops_prune(num_classes, image_shape, num_layers=2, load_param=None,
    ...
    return dsonas_adflops_prune(units=units,
