...
def dsonas_reduction_unit(data, num_filter, name, bn_mom=0.9, workspace=256):
    lambdas = mx.sym.Variable(shape=(1, 2), dtype='float32', lr_mult=1.0, wd_mult=0,
                              init=mx.init.One(), name="lambda_" + name)
...
def get_symbol_dsonas_search_full_adflops(num_classes, depth, image_shape, num_layers=2, conv_workspace=256,
